#compdef pychuck
# Zsh completion for pychuck CLI
# Install: Copy to a directory in $fpath (e.g., /usr/local/share/zsh/site-functions/_pychuck)
...
_pychuck() {
    ...
    case $state in
        command)
            ...
            _describe 'pychuck command' commands
            ;;
        args)
            case $line[1] in
                edit)
                    _arguments \
                        ...
                        '--project[Project name for versioned file storage]:project:_pychuck_projects' \
